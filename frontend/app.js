    ...
    container.innerHTML = days.map(d => {
        ...
        return `<div class="summary-card clickable" style="border-top: 3px solid ${color}" onclick="goToForecastDay('${d.fecha}')">
            ...
            <div class="summary-details">
                ...
                <span style="color:${swellColor(d.swell_max)}">Swell: ${d.swell_max != null ? d.swell_max.toFixed(2) + 'm' : '--'}</span><br>
                <span style="color:${chopColor(d.chop_max)}">Chop: ${d.chop_max != null ? d.chop_max.toFixed(2) + 'm' : '--'}</span><br>
...
function drawDetailChart(type) {
    ...
    if (type === 'viento') {
        ...
        if (lastArome === -1) {
            ...
            const d = new Date(t);
            modelNote = `AROME 1.5km hasta ${DAY_SHORT[d.getDay()]} ${t.slice(11, 16)}, luego global`;
    ...
    + (obsDrawn ? '<div class="chart-legend-item"><div class="chart-legend-dot" style="background:#fff;width:8px;height:8px;border-radius:50%"></div><span>Observado (Busto)</span></div>' : '')
    + (dirDrawn ? '<div class="chart-legend-item"><span>&#8593; flechas: hacia donde sopla (color = fuerza)</span></div>' : '')
